  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container" id="upperContainer">
        ...
        <p>저희 <b>SMU ASSET</b>은 소규모 자본을 모아 대규모 자본을 만들어 투자영역에 대한 확장성을 제공합니다.<br/> 또한 여러분의 투자성향을 파악하여 자본투자에 대한 성공적인 방향성 제시를 해주는 플랫폼입니다.<br/> 지금 바로 <b>SMU ASSET</b>과 함께 성공적인 투자를 시작하세요!</p><br/>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="/smu/gconsult" role="button">자세히 보기 &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <h2>개인 컨설팅</h2>
          <p>빅데이터 분석을 이용하여 고객님의 투자 성향을 파악하여 개인적으로 
          컨설팅을 제공 받을 수 있도록 최고수준의 투자자를 매칭 시킵니다. </p>
          <p><a class="btn btn-default" href="/smu/pconsult" role="button">자세히 보기 &raquo;</a></p>
       </div>
        <div class="col-md-4">
          <h2>금융뉴스</h2>
          <p>최신 금융뉴스를 제공하고 이에 대한 전문가들의 견해를 제공합니다. </p>
          <p><a class="btn btn-default" href="/smu/news" role="button">자세히 보기 &raquo;</a></p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
